...
namespace TempEvade {
    ...
    public class SpellDatabase {
        ...
        public static List<SpellDataBaseRecord> Spells = new List<SpellDataBaseRecord>();

        public static SpellDataBaseRecord GetRecord(string name)
        {
            return Spells.Find(record => record.spellName.Equals(name) || record.missileName.Equals(name));
        }
